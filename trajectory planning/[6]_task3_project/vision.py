...
class Vision(object):
	def __init__(self):
		...
		self.my_robot = Robot()
		self.my_robot_yellow=[Robot() for i in range(0,16)]
	...
	def parse_vision(self):
		...
		for robot_yellow in self.vision_frame.robots_yellow:
			...
			self.my_robot_yellow[robot_yellow.robot_id].x = robot_yellow.x
			self.my_robot_yellow[robot_yellow.robot_id].y = robot_yellow.y
			self.my_robot_yellow[robot_yellow.robot_id].vel_x = robot_yellow.vel_x
			self.my_robot_yellow[robot_yellow.robot_id].vel_y = robot_yellow.vel_y
			self.my_robot_yellow[robot_yellow.robot_id].orientation = robot_yellow.orientation
